...
<head>
  ...
  <link rel="stylesheet" href="http://localhost/examen/assets/css/estilos.css">
</head>
...
<body class="registro">
  ...
  <div class="relative md:ml-64 bg-blueGray-50">
    <nav class="absolute top-0 left-0 w-full z-10 bg-transparent md:flex-row md:flex-nowrap md:justify-start flex items-center p-4">
      <div class="w-full mx-autp items-center flex justify-between md:flex-nowrap flex-wrap md:px-10 px-4">
        <!-- boton primario -->
        <a class="botn text-black lg:inline-block font-semibold" href="crear_usuario.php">
          crear usuarios</a>
    ...
    <div class="tablausuarios">
      ...
      <div class="m-2 ">
        <h5 class="text-secundary text-center">tabla de usuarios</h5>
        <table class="table">
          <thead>
          ...
          <tbody>
            ...
            while ($datos = $sql->fetch_object()) { ?>
              <tr class="text-center">
                ...
                <td>
                  <a href="" btn btn-small btn btn-warning><i class='botonwarning bx bx-edit'></i></a>
                  <a href="" btn btn-small btn btn-danger><i class='botondanger bx bx-trash'></i></a>
                </td>
              </tr>
            <?php }
            ?>
