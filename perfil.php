                        ...
                        <div class="bg-white rounded-lg shadow-md mt-16 p-6">
                            ...
                            <div>
                                <div id="sobre-mi" class="tab-content active">
                                    <p class="mb-4">Desarrolladora de software apasionada por la tecnología y la innovación.</p>
                                    ...
                                    <div class="flex items-center text-gray-600">
                                        ...
                                        <a href="https://www.mariagarcia.com" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline">www.mariagarcia.com</a>
                                    </div>
                                </div>
                                ...
                                <div id="redes-sociales" class="tab-content">
                                    <div class="space-y-2">
                                        <div class="flex items-center">
                                            ...
                                            <a href="https://twitter.com/mariagarcia" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline">@mariagarcia</a>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <a href="https://facebook.com/maria.garcia" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline">maria.garcia</a>
                                        </div>
                                        <div class="flex items-center">
                                            ...
                                            <a href="https://instagram.com/maria.garcia.dev" target="_blank" rel="noopener noreferrer" class="text-blue-500 hover:underline">@maria.garcia.dev</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
