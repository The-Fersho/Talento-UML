...
if (!empty($_POST ["btnregistrar"])){
    if (!empty($_POST ["nombre"]) and !empty($_POST ["apellido"]) and !empty($_POST ["carnet"]) and !empty($_POST ["direccion"]) and !empty($_POST ["telefono"])){
        ...
        $sql=$conexion->query("INSERT INTO clientes (nombre, apellido, carnet, direccion, telefono) VALUES ('$nombre', '$apellido', '$cedula', '$direccion', '$telefono')");
        if ($sql==1) {
